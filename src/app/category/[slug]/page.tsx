...
export async function generateMetadata(
  ...
  return {
    title: category ? `Category: ${category.name}` : `Category: ${slug}`,
    openGraph: {
      images: ['/hero.png', ...previousImages],
    },
  };
}
...
export default async function CategoryPage({ params, searchParams }: PageProps) {
  ...
  const { posts, totalPages } = await getAllPosts(currentPage, 10, searchTerm, category.id);

...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = "About SayNoPest – Your Trusted Pest Control Guider";
  const description = "Learn how SayNoPest connects you with reliable pest control services. Discover our mission and commitment to keeping homes safe nationwide.";

export default async function Page() {
  return (
    <div>
      ...
      <p className="mb-6">With Lite, you get the best of both worlds: the ease of content management in WordPress and the performance optimization and developer-friendly features of Next.js. Whether you&rsquo;s re building a blog, a portfolio, or a dynamic content site, Lite ensures fast load times, excellent SEO, and a smooth user experience.</p>
